...
def web_simulation(vlan, registration, websites, inventory, linux_user, linux_path, windows_user, windows_bat_path, time):
...
def pdf_simulation(vlan, registration, pdf_json_path, inventory, linux_user, linux_path, windows_user, windows_bat_path, time):
...
def print_simulation(vlan, registration, pdf_json_path, inventory, windows_user, windows_bat_path, time):
...
def read_mail_simulation(vlan, inventory, windows_user, windows_bat_path, time):
