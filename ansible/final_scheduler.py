...
LINUX_USER = "student"
LINUX_WORKER_PATH = f"/home/{LINUX_USER}/user_behavior_generation/worker"

# --- CONFIGURAZIONE WINDOWS ---
WINDOWS_USER = "Student"  # Metti qui il nome utente vero
# Percorso su Windows (Nota le doppie barre rovesciate \\ per sicurezza in Python)
WINDOWS_BAT_PATH = f"C:\\Users\\{WINDOWS_USER}\\user_behavior_generation\\worker\\browser_task.bat"
